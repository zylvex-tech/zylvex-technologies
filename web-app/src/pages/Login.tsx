  ...
  return (
    <PageTransition>
      <div className="min-h-screen gradient-bg flex items-center justify-center px-4">
        <div className="absolute top-20 left-1/3 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-20 right-1/3 w-64 h-64 bg-purple-500/8 rounded-full blur-3xl pointer-events-none" />
